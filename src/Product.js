              ...
              {products.map((product) => {
                return (
                  <div className="col-lg-4">
                    ...
                    <div>
                    <Link to={`/product/${product.id}`} className="btn btn-lg-2 mr-2 btn-primary">View</Link>
                      <Link to={`/product/${product.id}`} className="btn btn-lg-2 mr-2 btn-success">Edit</Link>
